...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/citieoriginal/it-worker',
			'wwwDir' => '/var/www/html/citieoriginal/it-worker',
			'debugMode' => TRUE,
			...
			'tempDir' => '/var/www/html/citieoriginal/it-worker/php/temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/citieoriginal/it-worker/php/temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/citieoriginal/it-worker/php/temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/var/www/html/citieoriginal/it-worker/php/temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/var/www/html/citieoriginal/it-worker', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/var/www/html/citieoriginal/it-worker/php/temp/cache', $this->getService('nette.cacheJournal'));
